...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    footer_description: "Your trusted platform for buying and selling properties. Find your dream home or connect with buyers today.",
    footer_quick_links: "Quick Links",
    footer_home: "Home",
    footer_search: "Search Properties",
    footer_listings: "Listings",
    footer_news: "News",
    footer_legal: "Legal",
    ...
    footer_disclaimer: "All property information is provided by third parties and should be independently verified.",
    ...
    search_parish: "Parish",
    search_min_price: "Minimum Price",
    search_max_price: "Maximum Price",
    search_any: "Any",
    search_house: "House",
  ...
  pt: {
    ...
    footer_description: "Sua plataforma confiável para compra e venda de propriedades. Encontre a casa dos seus sonhos ou conecte-se com compradores hoje.",
    footer_quick_links: "Links Rápidos",
    footer_home: "Início",
    footer_search: "Procurar Propriedades",
    footer_listings: "Anúncios",
    ...
    footer_gdpr: "Conformidade RGPD",
    footer_contact: "Contacte-nos",
    footer_disclaimer: "Todas as informações sobre propriedades são fornecidas por terceiros e devem ser verificadas independentemente.",
    ...
    no_listings_found: "Nenhum anúncio encontrado. Tente ajustar os seus filtros.",
    error_loading_listings: "Erro ao carregar anúncios",
    ...
    search_transaction_type: "Tipo de Transação",
    search_sale: "Venda",
    search_rent: "Arrendamento",
    search_district: "Distrito",
    search_municipality: "Concelho",
    search_parish: "Freguesia",
    search_min_price: "Preço Mínimo",
    search_max_price: "Preço Máximo",
    search_any: "Qualquer",
    search_house: "Casa",
    ...
    change_area: "Alterar Área",
    clear_area: "Limpar Área",
